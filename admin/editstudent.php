...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="col-md-9 col-lg-10">
        ...
        <form class="needs-validation" method="post" enctype="multipart/form-data" action="studentupdate.php" >
        <div class="row g-3">
            <div class="col-sm-6">
              <label for="enroll" class="form-label">Enrollment No.</label>
              <input type="number" class="form-control" name="enroll" min="10000000000" max="99999999999" value="<?php echo $data['enroll']; ?>" id="enroll" placeholder="" required>
            ...
            <div class="col-md-12">
              ...
              <input class="form-control" value="<?php echo $data['picture']; ?>" type="file" name="picture" id="picture">
