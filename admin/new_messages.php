...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2 col-md-8">New Messages</h1>
        <form method="get">
...
if(isset($_GET['search']))
{
  ...
  $query="SELECT * FROM `contact` WHERE `student_id` LIKE '%$search_key%' AND `mark`='unread'";  
  }
  else{
    
    $query="SELECT * FROM `contact` WHERE `mark`='unread'";  
...
$run=mysqli_query($con,$query);
    ...
    <tr>
      ...
      <td><a class="link-danger text-decoration-none" href="mark_message.php?id=<?php echo $data['id']?>">Mark as read</a></td>
    </tr>
