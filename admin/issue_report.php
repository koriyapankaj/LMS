...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Student Book Details</h1>
      </div>
...
$query="SELECT * FROM `book_issue` WHERE `stu_id`='$id' AND `status`='issued'";  
...
$run=mysqli_query($con,$query);
    ...
    <tr>
      ...
      <td><a class="link-primary text-decoration-none" href="receive_book.php?id=<?php echo $data['id'].'&bookid='.$data['book_id'].'&stuid='.$data['stu_id']; ?>">Received</a></td>
      <td><a class="link-danger text-decoration-none" href="lost_book.php?id=<?php echo $data['id'].'&bookid='.$data['book_id'].'&stuid='.$data['stu_id']; ?>">Lost</a></td>
